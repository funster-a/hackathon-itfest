...
const translations: Record<Locale, Record<string, string>> = {
  ru: {
    ...
    'filters.languages': 'Язык обучения',
    'filters.selectLanguages': 'Выберите языки',
    ...
    'filters.universities': 'университетов',
    'filters.gridView': 'Вид сеткой',
    'filters.listView': 'Вид списком',
  ...
  kk: {
    ...
    'filters.languages': 'Оқыту тілі',
    'filters.selectLanguages': 'Тілдерді таңдаңыз',
    'filters.selected': 'таңдалды',
    'filters.reset': 'Тазалау',
    'filters.show': 'Сүзгілерді көрсету',
    'filters.hide': 'Сүзгілерді жасыру',
    'filters.found': 'Табылды',
    'filters.universities': 'университет',
    'filters.gridView': 'Тор түрінде',
    'filters.listView': 'Тізім түрінде',
  ...
  en: {
    ...
    'filters.languages': 'Language of Instruction',
    'filters.selectLanguages': 'Select languages',

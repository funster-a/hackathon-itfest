...
const translations: Record<Locale, Record<string, string>> = {
  ru: {
    ...
    'filters.disciplines': 'Академические дисциплины',
    'filters.selectDisciplines': 'Выберите дисциплины',
  ...
  kk: {
    ...
    'filters.disciplines': 'Академиялық пәндер',
    'filters.selectDisciplines': 'Пәндерді таңдаңыз',
  ...
  en: {
    ...
    'filters.disciplines': 'Academic Disciplines',
    'filters.selectDisciplines': 'Select disciplines',
